export const serviciosdetiMeta = {
  ...
  "servicios-de-soporte-para-comercio-electrónico": {
  ...
  "servicios-de-soporte-para-reparación-de-hardware": {
  ...
  "soporte-para-la-configuración-de-correo-electrónico": {
