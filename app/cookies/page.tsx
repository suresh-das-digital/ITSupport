...
export const metadata = {
  title: "Cookie Policy | Data & Privacy Practices – ITSupport.net.in",
  description: "Learn how ITSupport.net.in uses cookies to enhance your browsing experience. Our Cookie Policy outlines the types of cookies we use and how you can manage your preferences.",
  keywords: [
    "cookie policy",
    "website cookies",
    "cookie usage",
    "cookie management",
    "ITSupport.net.in cookies",
    "cookie consent",
    "GDPR compliance",
    "data privacy",
    "user tracking",
  ...
  alternates: {
    canonical: "https://www.itsupport.net.in/cookies/",
    languages: {
      "en": "https://www.itsupport.net.in/cookies/",
    }
  },
  openGraph: {
    type: "website",
    url: "https://www.itsupport.net.in/cookies/",
    title: "Cookie Policy – ITSupport.net.in",
    description: "Discover how ITSupport.net.in utilizes cookies to improve your experience. Our Cookie Policy provides transparency on cookie usage and management options.",
    siteName: "ITSupport.net.in Cookie Policy",
    locale: "en_US",
    images: [{
      url: "image-url",
      alt: "Cookie Policy – ITSupport.net.in",
      width: "Fix Size",
      height: "Fix Size",
      type: "images/webp",
  ...
  twitter: {
    ...
    creator: "@L4RGINDIA",
    title: "Cookie Policy – ITSupport.net.in",
    description: "Understand how ITSupport.net.in uses cookies to enhance your browsing experience. Our Cookie Policy details cookie types and management options.",
    url: "https://www.itsupport.net.in/cookies/",
    images: [{
      url: "image-url",
      alt: "Cookie Policy – ITSupport.net.in",
...
const schema = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "https://www.itsupport.net.in/cookies/#webpage",
      "url": "https://www.itsupport.net.in/cookies/",
      "name": "Cookie Policy | Data & Privacy Practices – ITSupport.net.in | IT Support",
      "description": "IT Support provides Cookie Policy | Data & Privacy Practices – ITSupport.net.in, managing the entire sales process from lead generation to deal closure, helping businesses increase revenue and optimize performance.",
      "inLanguage": "en",
      "datePublished": "2005-01-10T09:00:00+05:30",
      "dateModified": "2025-08-17T09:00:00+05:30",
      "publisher": {
        "@type": "Organization",
        "name": "IT Support Cookie Policy | Data & Privacy Practices – ITSupport.net.in",
        "logo": {
          "@type": "ImageObject",
          "url": "image-url"
        },
      ...
      "about": {
        "@type": "Thing",
        "name": "IT Support Services, Lead Generation, Sales Process Management, B2B Sales Solutions"
      }
    },

    {
      "@type": "Product",
      "@id": "#product",
      "name": "Cookie Policy | Data & Privacy Practices – ITSupport.net.in",
      "image": ["image-url"],
      "description": "IT Support offers comprehensive Cookie Policy | Data & Privacy Practices – ITSupport.net.in, managing the entire sales cycle from lead generation to deal closure, helping businesses increase revenue and optimize sales performance.",
      "url": "https://www.itsupport.net.in/cookies/",
      "aggregateRating": {
...

    {
      ...
      "itemListElement": [{
        ...
        },
        {
          ...
          "position": 2,
          "name": "Cookie Policy",
          "item": "https://www.itsupport.net.in/cookies/"
        }
      ]
    },

    {
      ...
      "potentialAction": {
        ...
        "target": {
          "@type": "EntryPoint",
          "urlTemplate": "https://www.itsupport.net.in/cookies//search?q={search_term_string}"
        },
...

    {
      ...
      "name": "Outstanding Cookie Policy | Data & Privacy Practices – ITSupport.net.in by IT Support",
      "url": "https://www.itsupport.net.in/cookies/",
      "image": "image-url",
...

    {
      ...
      "sameAs": [
        ...
        "https://www.itsupport.net.in/cookies/"
      ]
    },

    {
      ...
      "itemReviewed": {
        "@type": "Organization",
        "name": "IT Support Cookie Policy | Data & Privacy Practices – ITSupport.net.in",
        "sameAs": "https://www.itsupport.net.in/cookies/"
      },
      "ratingValue": "4.9",
      "bestRating": "5",
      "worstRating": "1",
...

    {
      ...
      "mainEntity": [{
          "@type": "Question",
          "name": "What are Cookie Policy | Data & Privacy Practices – ITSupport.net.in at IT Support?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "IT Support provides comprehensive Cookie Policy | Data & Privacy Practices – ITSupport.net.in, managing the entire sales cycle from lead generation to deal closure, ensuring consistent revenue growth for businesses."
          }
        },
        {
          "@type": "Question",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, IT Support tailors its IT Support Services strategies to fit each industry's unique needs, ensuring that lead generation, client outreach, and deal closing processes are optimized for maximum effectiveness."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "Why should companies choose IT Support for IT Support Services?",
          "acceptedAnswer": {
            "@type": "Answer",
...

    {
      ...
      "mainEntity": {
        "@type": "Question",
        "name": "What services are included in IT Support's IT Support Services?",
        ...
        "acceptedAnswer": {
          ...
          "upvoteCount": 10,
          "url": "https://www.itsupport.net.in/cookies/#q1a1",
          "author": {
            "@type": "Person",
            "name": "Mickey Taylor",
            "url": "https://www.itsupport.net.in/cookies/"
...

    {
      ...
      "mainEntity": {
        ...
        "acceptedAnswer": {
          ...
          "upvoteCount": 8,
          "url": "https://www.itsupport.net.in/cookies/#q3a1",
          "author": {
            "@type": "Person",
            "name": "Mike David",
            "url": "https://www.itsupport.net.in/cookies/"
...

    {
      ...
      "mainEntity": {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes, IT Support customizes its IT Support Services strategies according to industry, business size, and target market, ensuring optimized lead generation, engagement, and conversion rates.",
          "dateCreated": "2025-07-14T10:15:00+05:30",
          "upvoteCount": 7,
          "url": "https://www.itsupport.net.in/cookies/#q4a1",
          "author": {
            "@type": "Person",
            "name": "Robin Woods",
            "url": "https://www.itsupport.net.in/cookies/"
