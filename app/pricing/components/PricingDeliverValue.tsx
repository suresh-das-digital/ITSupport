...
const achievementData = [
    ...
    desc: "No billing surprises.",
    },
    {
    title: "All-Inclusive Support",
    desc: "Avoid costly downtime and repairs.",
    },
    {
    title: "Expert Access",
    desc: "Get help from certified IT specialists anytime.",
    },
    {
    title: "Proactive Monitoring",
    desc: "We solve issues before they affect your business.",
    },
    {
    title: "Custom Scalability",
    desc: "Upgrade or downgrade plans anytime.",
    }
]

export default function PricingDeliverValue() {
  ...
  return (
    <section className="py-16 px-4 sm:px-6 bg-[#f4f7fa]">
      <div className="max-w-6xl 2xl:max-w-[1488px] mx-auto">
        ...
        How Our Pricing Delivers Value
        </h2>
